...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:tei="http://www.tei-c.org/ns/1.0" xmlns="http://www.w3.org/1999/xhtml">
    ...
    <xsl:template match="/">
        <html>
            ...
            <body>
                ...
                <main>
                    <div id="descrizione" class="descrizione">
                        ...
                        <div id="card_descrizione">
                            ...
                            <xsl:apply-templates select="//tei:sourceDesc[@xml:id='fascicolo_uno']" />
                        </div>
                    </div>
                    ...
                    <section class="descrizione">   
                        <div class="card_descrizione" id="order_2">
                            <xsl:apply-templates select="//tei:msDesc/tei:physDesc[@xml:id='risorsa1']" />
                        </div>
                    </section>
                    <!-- Storia editoriale -->
                    <section class="descrizione">
                        <div class="card_descrizione">
                            <xsl:apply-templates select="//tei:history[@xml:id='one']" />
                        </div>
                    </section>
                    <nav id="info">
                        <h2> I documenti</h2>
                    ...
                    <section class="documenti">
                        ...
                        <div class="testi">
                            <xsl:apply-templates select="//tei:body[@xml:id='fascicolo_testo1']"/>
                            <span id="testo"></span>
                        </div>    
                    </section>
                ...
                <!-- javaScript -->
                <script src="fascicolo1.js"></script>
            </body>
        </html>
    </xsl:template>

    <xsl:template match="tei:sourceDesc[@xml:id='fascicolo_uno']">
        <h1><xsl:value-of select="//tei:title[@xml:id='pagina1']" /></h1>
        <h3>Titolo:</h3>
        <p><xsl:value-of select="//tei:title[@xml:id='pagina1']"/></p>
    ...
    <xsl:template match="tei:facsimile[@xml:id='fascicolo1']">
    ...
    <!-- testo --> 
    <xsl:template match="tei:body[@xml:id='fascicolo_testo1']">
